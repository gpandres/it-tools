...
export function Sidebar() {
  ...
  const navigation = (
    <nav aria-label="Tools" className="flex min-h-0 flex-1 flex-col px-3 pb-3 pt-4">
  ...
  return <>
    ...
    <aside className="sticky top-0 hidden h-screen w-64 shrink-0 flex-col overflow-hidden border-r border-[#1a1a1a] bg-[#050505] md:flex"><div className="border-b border-[#1a1a1a] px-4 py-5"><Link href="/" className="font-bold text-xl tracking-widest text-[#ffb000]">IT_TOOLS<span className="cursor-blink text-[#00ff9c]">_</span></Link><p className="mt-2 text-[10px] tracking-widest text-zinc-500">LOCAL-FIRST · NO TRACKING</p></div>{navigation}{footer}</aside>
  </>;
}
