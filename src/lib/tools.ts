...
export const toolsRegistry: ToolDefinition[] = [
  ...
  {
    id: "event-ids",
    name: "Windows Event & Sysmon Lookup",
    description: "Quick reference for critical Windows Security Event IDs and Sysmon events.",
    category: "CYBERSECURITY / BLUE TEAM",
    path: "/tools/security/event-ids",
    keywords: ["event", "id", "windows", "sysmon", "security", "log", "4624", "reference", "mitre", "attack"],
    aliases: ["Event ID Cheat Sheet", "Sysmon Reference"],
    technologies: ["Windows", "Active Directory", "Sysmon"],
    vendors: ["Microsoft"],
    offline: true,
  },
  {
