...
export const toolsRegistry: ToolDefinition[] = [
  ...
  },
  {
    ...
    keywords: ["interface", "config", "ip", "cisco", "mikrotik", "fortigate", "juniper", "arista", "junos", "eos", "router", "switch", "generate"],
    aliases: ["Interface Config Builder", "Router Interface Config"],
    technologies: ["Networking", "CLI"],
    vendors: ["Cisco", "MikroTik", "Fortinet", "Juniper", "Arista"],
    offline: true,
  },
  {
    id: "vlan-tool",
    name: "VLAN Calculator & Config",
    description: "Calculate VLAN ranges and generate 802.1Q access/trunk configurations for Cisco, MikroTik, FortiGate, Juniper, and Arista.",
    category: "NETWORKING",
    path: "/tools/network/vlan",
    keywords: ["vlan", "802.1q", "trunk", "access", "port", "switch", "native", "tagged", "untagged", "cisco", "mikrotik", "fortigate", "juniper", "arista"],
  ...
  {
    id: "sigma-builder",
    name: "Sigma Rule Builder",
    description: "Create portable Sigma detection rules locally for SIEM and EDR workflows.",
    category: "CYBERSECURITY / BLUE TEAM",
    path: "/tools/security/sigma-builder",
    keywords: ["sigma", "detection", "siem", "edr", "rule", "blue team", "log"],
    aliases: ["Detection Rule Builder", "SIEM Rule Generator"],
    technologies: ["Sigma", "YAML", "Detection Engineering"],
    offline: true,
  },
  {
    id: "email-analyzer",
    name: "Email Security Analyzer",
    description: "Inspect email headers locally for SPF, DKIM, DMARC and phishing indicators.",
    category: "CYBERSECURITY / BLUE TEAM",
    path: "/tools/security/email-analyzer",
    keywords: ["email", "header", "spf", "dkim", "dmarc", "phishing", "forensics"],
    aliases: ["Email Header Analyzer", "Phishing Header Check"],
    technologies: ["Email Security", "DMARC"],
    offline: true,
  },
  {
    id: "ad-path-analyzer",
    name: "Active Directory Attack Path Analyzer",
    description: "Review BloodHound-style relationships locally and prioritize Tier 0 exposure.",
    category: "CYBERSECURITY / BLUE TEAM",
    path: "/tools/security/ad-path-analyzer",
    keywords: ["active directory", "ad", "bloodhound", "attack path", "kerberos", "privilege", "tier 0"],
    aliases: ["BloodHound Path Review", "AD Privilege Path"],
    technologies: ["Active Directory", "BloodHound"],
    offline: true,
  },
  {
    id: "roe-builder",
    name: "Rules of Engagement Builder",
    description: "Create a bounded, safety-first pentest scope document before testing.",
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/security/roe-builder",
    keywords: ["rules of engagement", "roe", "pentest", "scope", "authorization", "safe testing"],
    aliases: ["Pentest Scope Builder", "Assessment Authorization"],
    technologies: ["Security Testing", "Markdown"],
    offline: true,
  },
  {
    id: "mitre-reference",
  ...
  // ==========================================
  {
    ...
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/http-request",
    keywords: ["http", "request", "builder", "curl", "api", "rest", "headers", "payload", "fetch", "web"],
    aliases: ["Request Maker", "cURL Generator"],
  ...
  },
  {
    ...
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/payload-encoder",
    keywords: ["payload", "encoder", "decoder", "transform", "pipeline", "url", "base64", "hex", "escape"],
    aliases: ["Payload Transformer", "Encoder Pipeline"],
    technologies: ["Encoding", "Security"],
    offline: true,
  },
  {
    id: "web-payload-lab",
    name: "Web Payload Lab",
    description: "Explore and transform common web security payloads in a local educational sandbox.",
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/web-payload-lab",
    keywords: ["payload", "lab", "xss", "sqli", "ssti", "injection", "sandbox", "learning", "ctf"],
    aliases: ["Injection Lab", "Vulnerability Sandbox"],
    technologies: ["Web Security", "OWASP"],
    offline: true,
  },
  {
    id: "reverse-shell-reference",
    ...
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/reverse-shell-reference",
    keywords: ["reverse shell", "shell", "bash", "netcat", "socat", "python", "php", "powershell", "bind shell", "reference"],
    aliases: ["Shell Cheatsheet", "Reverse Shell Generator"],
    technologies: ["Networking", "CLI"],
    offline: true,
  },
  {
    id: "dns-recon",
    name: "DNS Recon",
    description: "Analyze DNS information and organize authorized reconnaissance data.",
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/dns-recon",
  ...
  },
  {
    ...
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/attack-surface",
    keywords: ["attack", "surface", "map", "mapper", "assets", "endpoints", "technologies", "findings", "pentest", "assessment"],
    aliases: ["Pentest Mapper", "Asset Tracker"],
    technologies: ["Security", "Documentation"],
    offline: true,
  },
  {
    id: "wordlist-analyzer",
    name: "Wordlist Analyzer",
    description: "Analyze, filter, and clean wordlists locally without uploading files.",
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/wordlist",
    keywords: ["wordlist", "dictionary", "analyze", "clean", "filter", "duplicates", "brute force", "passwords"],
    aliases: ["Dictionary Cleaner", "Wordlist Processor"],
    technologies: ["Text Processing"],
    offline: true,
  },
  {
    id: "hash-identifier",
    name: "Hash / Format Identifier",
    description: "Identify possible hashing algorithms or encoding formats based on string length and charset.",
    category: "CYBERSECURITY / RED TEAM",
    path: "/tools/redteam/hash-identifier",
    keywords: ["hash", "identify", "format", "detect", "md5", "sha1", "sha256", "base64", "recognize"],
    aliases: ["Hash Detector", "Format Analyzer"],
    technologies: ["Cryptography", "Encoding"],
    offline: true,
  },
  ...
  },
  {
    id: "sbom-generator",
    name: "SBOM Generator",
    description: "Generate a local CycloneDX software bill of materials from dependency lists.",
    category: "DEVOPS",
    path: "/tools/devops/sbom-generator",
    keywords: ["sbom", "cyclonedx", "spdx", "dependencies", "supply chain", "components"],
    aliases: ["Software Bill of Materials", "Dependency Inventory"],
    technologies: ["CycloneDX", "DevSecOps"],
    offline: true,
  },
  {
    id: "dockerfile-linter",
    name: "Dockerfile Security Linter",
    description: "Review Dockerfiles for unsafe images, privilege, embedded secrets and supply-chain risks.",
    category: "DEVOPS",
    path: "/tools/devops/dockerfile-linter",
    keywords: ["dockerfile", "lint", "security", "container", "root", "secret", "supply chain"],
    aliases: ["Dockerfile Auditor", "Container Linter"],
    technologies: ["Docker", "Containers"],
    offline: true,
  },
  {
    ...
    description: "Audit Kubernetes YAML for privilege, RBAC, secrets, images and workload-hardening issues.",
    category: "DEVOPS",
    path: "/tools/devops/kubernetes-auditor",
    keywords: ["kubernetes", "k8s", "yaml", "manifest", "rbac", "pod", "container", "security"],
    aliases: ["K8s Security Auditor", "Kubernetes Linter"],
  ...
  },
  {
    ...
    description: "Inspect Terraform configuration for public exposure, weak IAM, secrets and unsafe defaults.",
    category: "DEVOPS",
    path: "/tools/devops/terraform-analyzer",
    keywords: ["terraform", "hcl", "iac", "cloud", "iam", "security group", "s3", "security"],
    aliases: ["Terraform Linter", "IaC Security Review"],
  ...
  },
  {
    ...
    description: "Find common credential patterns in source, configuration, logs and environment files locally.",
    category: "DEVOPS",
    path: "/tools/devops/secrets-scanner",
    keywords: ["secrets", "credentials", "token", "api key", "password", "env", "scan"],
    aliases: ["Credential Scanner", "Secret Detector"],
    technologies: ["DevSecOps", "Source Code"],
    offline: true,
  },
  {
    id: "github-actions-auditor",
    name: "GitHub Actions Security Auditor",
    description: "Review workflows for excessive permissions, injection risks and mutable third-party actions.",
    category: "DEVOPS",
    path: "/tools/devops/github-actions-auditor",
    keywords: ["github actions", "ci", "cd", "workflow", "pipeline", "permissions", "supply chain"],
    aliases: ["CI/CD Auditor", "Workflow Security"],
    technologies: ["GitHub Actions", "CI/CD", "YAML"],
    vendors: ["GitHub"],
    offline: true,
  },
  ...
  // ==========================================
  {
    ...
    aliases: ["Platform Command Library", "Quick Command Sheet"],
    technologies: [],
    offline: true,
  },
  {
