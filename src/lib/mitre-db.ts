...
export const MITRE_DB: MitreDef[] = [
  ...
  { id: "T1558", tactic: "Credential Access", name: "Steal or Forge Kerberos Tickets", description: "Adversaries may attempt to steal or forge Kerberos tickets to enable pass-the-ticket or Forge Golden/Silver tickets.", example: "Performing a Kerberoasting attack to request service tickets and crack them offline.", icon: Key, color: "text-pink-500", platform: "Windows" },
  ...
  { id: "T1098", tactic: "Impact", name: "Account Manipulation", description: "Adversaries may manipulate accounts to maintain access to victim systems.", example: "Changing the password of critical service accounts to lock out defenders.", icon: AlertTriangle, color: "text-red-600", platform: "Cross-Platform" }
];
