...
export const MITRE_DB: MitreDef[] = [
  ...
  { id: "T1070.001", parentId: "T1070", tactic: "Stealth", name: "Clear Windows Event Logs", description: "Adversaries may clear Windows Event Logs to hide the activity of an intrusion.", example: "Clearing the Windows Security Event Logs using wevtutil cl Security.", icon: ShieldOff, color: "text-red-400", platform: "Windows" },
  { id: "T1070.002", parentId: "T1070", tactic: "Stealth", name: "Clear Linux or Mac System Logs", description: "Adversaries may clear system logs to hide the activity of an intrusion.", example: "Clearing or echoing an empty string into /var/log/auth.log.", icon: ShieldOff, color: "text-red-400", platform: "Linux" },
  { id: "T1070.003", parentId: "T1070", tactic: "Stealth", name: "Clear Command History", description: "Adversaries may clear the command history of a compromised account to hide the actions performed.", example: "Deleting the ~/.bash_history file or running history -c.", icon: ShieldOff, color: "text-red-400", platform: "Linux" },
